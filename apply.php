...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (empty($errors)) {
    $stmt = $conn->prepare("
      INSERT INTO adoption_requests(user_id, dog_id, full_name, phone, address, email, reason, status)
      VALUES(:user_id, :dog_id, :full_name, :phone, :address, :email, :reason, 'pending')
