...
<section class="home">
    <div class="teksti">
        ...
        <a href="adopt.html"><button id="butoni" type="submit">Get Started!</button></a>
    </div>
    <div class="imazhi">
...
<section class="adopt-hero">
    ...
    <a href="adopt.html"><button class="adopt-btn" type="submit">Start Your Adoption Journey</button></a>
</section>
